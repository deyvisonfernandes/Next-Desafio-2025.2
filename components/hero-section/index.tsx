...
export default function HeroSection(){
    ...
    return(
        <div className="w-full flex flex-col lg:grid lg:grid-flow-col lg:grid-cols-6 items-center gap-6 bg-black lg:p-10  2xl:p-30">
            <div className="flex flex-col justify-center gap-12 lg:col-span-3 p-8 md:p-16 h-auto lg:max-h-[700px] overflow-hidden">
                <div className="flex flex-col gap-6 leading-relaxed  2xl:gap-15">
                ...
                text-xl md:text-3xl lg:text-4xl 2xl:text-7xl 3xl:text-7xl
